...
function FormulaHelper({ userId }: { userId: string }) {
  ...
  async function ask() {
    ...
    const res = await askAI(
      ...
      "You are an expert math and science tutor who writes long, thorough, complete explanations — never brief ones. Always use proper markdown formatting with bold for key terms. Never reveal AI provider names.",
    );
